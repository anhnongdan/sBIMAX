...
class AbTesting extends Plugin
{
    ...
    public function addSubcategories(&$subcategories)
    {
        ...
        $experiments = $this->getExperimentsModel()->getExperimentsWithReports($idSite);
    ...
    public function getClientSideTranslationKeys(&$result)
    {
        ...
        $result[] = 'AbTesting_FieldIncludedTargetsHelp';
    ...
    {
        $experiments = $this->getExperimentsModel();
        ...
        $segment->setSuggestedValuesCallback(function ($idSite, $maxValuesToReturn) use ($experiments) {
