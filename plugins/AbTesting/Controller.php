...
class Controller extends \Piwik\Plugin\Controller
{
    ...
    public function __construct(Metrics $metrics, Experiments $experiments)
    {
        parent::__construct();
    ...
    public function summary()
    {
        ...
        $experiment = $this->initExperimentView();
        $isAdmin = Piwik::isUserHasAdminAccess($this->idSite);
    ...
    private function initExperimentView()
    {
        ...
        $experiment = $this->experiments->getExperiment($idExperiment, $this->idSite);
