...
class API extends \Piwik\Plugin\API
{
    ...
    public function __construct(Validator $validator, Aggregator $aggregator, SiteHsrModel $siteHsr, LogHsr $logHsr, LogHsrEvent $logEvent, LogHsrSite $logHsrSite, SystemSettings $settings)
    {
