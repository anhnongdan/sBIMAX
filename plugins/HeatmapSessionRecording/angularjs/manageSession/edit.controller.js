...
(function () {
    ...
    SessionRecordingEditController.$inject = ['$scope', 'hsrModel', 'piwik', '$location', '$filter', '$timeout', '$rootScope'];

    function SessionRecordingEditController($scope, hsrModel, piwik, $location, $filter, $timeout, $rootScope) {
        ...
        var i;
        this.sampleLimits = [];
        var sampleLimits = [50, 100, 250, 500, 1000, 2000, 5000];
