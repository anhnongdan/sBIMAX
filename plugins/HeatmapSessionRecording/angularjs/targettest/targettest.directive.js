        ...
        return {
            ...
            controller: function ($scope) {
                ...
                function checkIsMatchingUrl()
                {
                    ...
                    validateUrlPromise = piwikApi.post({method: 'HeatmapSessionRecording.testUrlMatchPages', url: url}, {matchPageRules: included});
                    validateUrlPromise.then(function (response) {
                        ...
                        if (!response || !response.url || response.url != $scope.targetTest.url) {
                            return;
                        }
