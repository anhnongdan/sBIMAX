...
class GetRecordedSessions extends Report
{
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        if (!empty($idSite) && !empty($idSiteHsr)) {
            ...
            $recording = $model->getSessionRecording($idSite, $idSiteHsr);
            if (!empty($recording)) {
        ...
        $view->config->custom_parameters['adminAccess'] = Piwik::isUserHasAdminAccess($idSite);
